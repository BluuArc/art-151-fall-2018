class Maze {
  ...
  _initializeRooms () {
    ...
    this._chestRooms.push(this.generateRandomPosition(filledRooms));
    this._chestRooms.push(this.generateRandomPosition(filledRooms.concat([this._chestRooms[0]])));
    filledRooms = filledRooms.concat(this._chestRooms);
