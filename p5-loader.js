(() => {
    ...
    const mappings = {
      ...
      p5Sound: ['https://cdnjs.cloudflare.com/ajax/libs/p5.js/0.7.1/addons/p5.sound.js', '../processing-3.4/p5-addons/p5.sound.js'],
    }
    ...
    const p5Loader = {
      ...
      loadP5Sound: () => loadScript(mappings.p5Sound),
    }
